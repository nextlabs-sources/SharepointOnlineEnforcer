...
my	$majorVer = 0;
my	$minorVer = 0;
my	$msiFilePrefix = "sharepointonline-enforcer";
...
my	$installDir = "$buildRootDir/install/Scripts/SharepointOnlineEnforcer";
...
my	$srcScriptDir = "$installDir/SharepointOnlineEnforcer";
my	$destScriptDir = "$assemblyDir/SharepointOnlineEnforcer";
